...
/5_plot_charge.py
'''
#script_name='/5_plot_charge_fit_3_parameters.py'

script_name='/5_plot_charge_FIT.py'
#'/5_plot_charge_FIT.py' #extracts only the name of the script
