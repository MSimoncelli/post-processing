...
/4_plot_CordNum_PDF.py
'''
script_name='/4_plot_deg_conf.py' #extracts only the name of the script
scr_runmin='%d'%(runmin)

list_arg_script =[] #NO ARGS FOR THIS PLOT
...
#'/4_coord_num_results/4_coord_number_0_56_cutoff_dataset_NaCl_1'
