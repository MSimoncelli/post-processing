...
unique_path_to_launch='/dos/Google_Drive/UNI_magistrale/2_anno/2_semestre_tesi/postprocessing/results/general/KUBO_conductivity'
...
for pdf_file in list_pdf_file:
        ...
        target_path=pdf_file.split('_Kubo_cond')[1]
