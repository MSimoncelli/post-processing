...
if (list_dir[11]=='1.0V'):
	...
	Q_1max=Q_1max2
	Q_2max=Q_2max1
	Rl_1, cov_Rl_1 = curve_fit(Q_function_2, time_array, -data_slice_1, p0=(0.06),bounds=([0.0],[1.0000]), method='trf')#, p0=(1,5,10),bounds=([0,90,10],[20,120,80]), method='trf')#*(-1), p0=(10**9,100**-19,30**-19))#,bounds=([10**7,10**-19,5*10**-19],[10**10,150*10**-19,150*10**-19]), method='trf')
	...
	Q_1max=Q_1max3
	Q_2max=Q_2max4
	Rl_3, cov_Rl_3 = curve_fit(Q_function_1, time_array,data_slice_3, p0=(0.06),bounds=([0.0],[1.0000]), method='trf')#, p0=(1,5,10),bounds=([0,90,10],[20,120,80]), method='trf')#*(-1), p0=(10**9,100**-19,30**-19))#,bounds=([10**7,10**-19,5*10**-19],[10**10,150*10**-19,150*10**-19]), method='trf')
