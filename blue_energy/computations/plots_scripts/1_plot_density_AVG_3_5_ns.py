...
#print list_dir
name_file_save=r'c_1_AVG_density_%03d-run%03d_%s_%s_%s_%s' %(runmin,runmax, list_dir[8],list_dir[9],list_dir[10],list_dir[11] )
...
title= r'Average density from 3.0 to 3.5 ns run%03d-%03d %s %s %s %s' %(runmin,runmax, list_dir[8],list_dir[9],list_dir[10],list_dir[11])
