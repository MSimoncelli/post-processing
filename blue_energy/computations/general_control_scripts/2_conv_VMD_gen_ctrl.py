...
script_folder_1='/2_convert_position2VMD' #pay attention at the arguments
script_name_1='/convert_VMD.py' #extracts only the name of the script

scr_max_run='%d'%(runmax)
list_arg_script_1=['0', scr_max_run]
