...
fileout='out_min_dist_approach.dat'
...
do w=1,num_configs
   ...
   do i=1,n_ions
      ...
      do k=1,n_dist  
         do j=1,n_specie_dist(k)
            ...
            if (buf_dist.lt.min_dist(specie,k)) then
               min_dist(i,k)=buf_dist
            end if
         end do
   ...
   do i=1,n_ions
      if (i.le.n_ions/2) then
         !write(22,'(A A i4 A i4 A i4 A i4 A i4)')'Na',tb,i,tb, min_dist(i,1),tb,min_dist(i,2),tb, min_dist(i,3),tb,min_dist(i,4)
         write(22,'(A A i4 f10.3 f10.3 f10.3 A f10.3 A f10.3 A f10.3 A f10.3)')'Na',tb,i,ion_p(i,:), &
         tb, min_dist(i,1),tb,min_dist(i,2),tb, min_dist(i,3),tb,min_dist(i,4)
      else
         write(22,'(A A i4 f10.3 f10.3 f10.3 A f10.3 A f10.3 A f10.3 A f10.3)')'Cl',tb,i-160,ion_p(i,:), &
         tb, min_dist(i,1),tb,min_dist(i,2),tb, min_dist(i,3),tb,min_dist(i,4)
      end if
   end do
   min_dist(:,:)=100
